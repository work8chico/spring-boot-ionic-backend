...
import com.chico.cursomc.domain.Pagamento;
import com.chico.cursomc.domain.PagamentoComBoleto;
import com.chico.cursomc.domain.PagamentoComCartao;
...
import com.chico.cursomc.repositories.EnderecoRepository;
...
import com.chico.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		produtoRepository.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21,
				p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p34, p35, p36, p37, p38,
				p39, p40, p41, p42, p43, p44, p45, p46, p47, p48, p49, p50));
		...
		Endereco e3 = new Endereco(null, "Rua Pedreira", "258", "apto 300", "Campeche", "88065546", cli2, c3);
		Endereco e4 = new Endereco(null, "Serv. Rocha", "670", "casa", "Red River", "88000333", cli2, c3);
